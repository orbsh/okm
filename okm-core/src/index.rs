...
/// schema are rejected.
///
/// Generated by `#[derive(ObjEncode)]`; the declaration is the single
...
pub trait Row: Sized + Clone {
    ...
    /// `#[ok_ref]` pins the key type, so `Table<S, K, R>` is fully
...
/// structs (`#[derive(ObjEncode)]` + `#[ok_index(...)]`); slots derive
